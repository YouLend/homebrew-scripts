...
print_help() {
    ...
    printf "%s     ╚═ \033[1mth clean          | c\033[0m   : Clean up Teleport session.\n" "$center_spaces"
    ...
    printf "%s     ╚═ \033[1mDocs:             | doc\033[0m\n" "$center_spaces"
    printf "%s     ╚═ \033[1mQuickstart:       | qs\033[0m\n\n" "$center_spaces"
...
print_aws_help() {
    ...
    printf "    ╚═ \033[1m[opt_args]\033[0m takes a combination of s/ss and/or b, Where:
       ║
       ╚═ \033[1ms/ss\033[0m determines whether you login with the \033[1msudo\033[0m or \033[1msuper_sudo\033[0m
       ║  role associated with the account.
       ╚═ \033[1mb\033[0m opens the browser for the chosen account & role.\n\n"
    printf "Examples:\n"
